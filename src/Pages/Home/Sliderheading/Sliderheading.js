                ...
                <div className="">
                    <div className='relative mt-1'>
                        ...
                        <div className="absolute top-0 py-[35px] px-[40px]">
                            ...
                            <button className='text-[18px] font-semibold bg-[#08192b] h-[44px] leading-[44px] rounded-[3px] text-white px-[30px]'>Get it on Google Play <span><i className="fa-brands fa-google-play ml-2"></i></span></button>
                        </div>
                    </div>
                </div>
                <div className="">
